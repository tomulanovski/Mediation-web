  ...
  return (
    <div>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto prose-sm sm:prose font-sans text-[#5a6a7a] leading-relaxed space-y-8">
            <p>
              We recognize that you may be concerned about our use and disclosure of your personal
              information. Your privacy is very important to us, and the following will inform you of
              the information that we, {siteConfig.name}, may collect from you, and how it is used.
              By using our website, {siteConfig.url.replace("https://", "")}, you are accepting the
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#1a1a1a] mb-4">Information Use</h2>
              <p>
                We use the collected information primarily for our own internal purposes, such as
                providing, maintaining, evaluating, and improving our services and Website, fulfilling
                requests for information, and providing customer support.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-semibold text-[#1a1a1a] mb-4">Security</h2>
              <p className="mb-4">
                We follow generally accepted industry standards to protect the information submitted to
                us, both during transmission and once we receive it.
              </p>
              <p className="mb-4">
                If we collect sensitive information (such as credit card data), that information is
            ...
            <div>
              ...
              <p>
                ...
                to track and target the interests of our users to enhance the experience on our site.
                Usage of a cookie is in no way linked to any personally identifiable information on our
                site.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-semibold text-[#1a1a1a] mb-4">Sharing</h2>
              <p className="mb-4">
                We will not sell or otherwise provide the information we collect to outside third parties
                for the purpose of direct or indirect mass email marketing.
              </p>
              <p className="mb-4">
                We will disclose personal information and/or an IP address, when required by law or in
                the good-faith belief that such action is necessary to:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Cooperate with the investigations of purported unlawful activities and conform to the
                  edicts of the law or comply with legal process served on our company
                </li>
                <li>
                  Protect and defend the rights or property of our Website and related properties
                </li>
                <li>
                  Identify persons who may be violating the law, the rights of third parties, or
              ...
              <p className="mt-4">
                ...
                for example through e-mail, discussion boards, or elsewhere — that information can be
                collected and used by others. In short, if you post personal information online that is
                accessible to the public, you may receive unsolicited messages from other parties in
                return.
              </p>
              <p className="mt-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#1a1a1a] mb-4">Links</h2>
              <p>
            ...
            <div>
              ...
              <p>
                ...
                (such as zip code, age). Contact information will be used to notify the winners and award
                prizes. Survey information will be used for purposes of monitoring or improving the use
                and satisfaction of this site.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-semibold text-[#1a1a1a] mb-4">Consent</h2>
              <p className="mb-4">
                ...
                Please review this page frequently to remain up-to-date with the information we collect,
                how we use it, and under what circumstances we disclose it. You must review the new
                Privacy Policy carefully to make sure you understand our practices and procedures.
              </p>
              <p>
                ...
                <a
                  ...
                  className="text-[#3b7797] hover:underline"
                >
                  {siteConfig.phone}
                </a>
                .
